...
SECRET_KEY = 'django-insecure-@jm_vd$i!v(aayo6zfq=^j5!dnq=wsz_r03(s9e5ejn!w8e279'
...
AUTH_USER_MODEL = 'libreria.Utente'
...
# Voglio dire a Django che i file statici devono iniziare con /static/
STATIC_URL = '/static/'
